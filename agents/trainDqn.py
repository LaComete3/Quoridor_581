    ...
    target_q_network_sync_period: int
        ...
        for episode in tqdm(range( episodes)):
            ...
            while not done:
                ...
                agent.epsilon_greedy.decay_epsilon()   
...
for train_index in range(NUMBER_OF_TRAININGS):
    ...
    agent2_dqn = DQNAgent(state_size=observation_dim, action_size=env1.action_space_size)
    #training
    ...
    print("Récompenses par épisode :", episode_rewards_agent1)
...
palette = sns.color_palette("tab10", unique_trainings)  # Choisit une palette de 10 couleurs
...
g = sns.relplot(
    ...
    kind="line", 
    hue="training_index",  # Utilisation de "training_index" pour colorer par entraînement
    palette=palette,  # Application de la palette
    estimator=None, 
    units="training_index",  # Tracer les résultats de chaque entraînement
